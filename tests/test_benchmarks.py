...
class TestBaseBenchmarkDataset(unittest.TestCase):
    ...
    def test_batch_generate_removed_from_base_vlm(self):
        self.assertFalse(hasattr(BaseVLM, "batch_generate"))
    ...
    def test_run_evaluation(self):
        ...
        eval_res = dataset.run_evaluation(mock_model, on_sample=reporter)
